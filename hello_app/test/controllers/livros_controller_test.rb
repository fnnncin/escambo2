...
class LivrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create livro" do
    assert_difference('Livro.count') do
      post livros_url, params: { livro: { autor: @livro.autor, dono: @livro.dono, editora: @livro.editora, genero: @livro.genero, telefone: @livro.telefone, titulo: @livro.titulo } }
    end
  ...
  test "should update livro" do
    patch livro_url(@livro), params: { livro: { autor: @livro.autor, dono: @livro.dono, editora: @livro.editora, genero: @livro.genero, telefone: @livro.telefone, titulo: @livro.titulo } }
